        ...
        while (!voltar) {
            ...
            switch (escolhaEspacos) {
                case 1:
                    ...
                    controller.adicionarProfessor(nome, LocalDate.of(2024, 9, 16) , cpf, telefone, email, senha, formacao);
                    break;
                case 2:
        ...
        while (!voltar) {
            ...
            switch (escolhaAdministrador) {
                case 1:
                    ...
                    controller.adicionarAdministrador(nome, LocalDate.of(2024, 9, 16) , cpf, telefone, email, senha, funcao);
                    break;
                case 2:
